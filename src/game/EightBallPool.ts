...
function createBarriers(): Array<Barrier> {
	const top = new Barrier({restitution: 0.8, shape: new BarrierShape({transform: new Transform(new Vector2({x: 200, y: 30}), 0), width: 340, height: 50})})
	const bottom = new Barrier({restitution: 0.8, shape: new BarrierShape({transform: new Transform(new Vector2({x: 200, y: 670}), 0), width: 340, height: 50})})
	const left = new Barrier({restitution: 0.8, shape: new BarrierShape({transform: new Transform(new Vector2({x: 30, y: 350}), 0), width: 30, height: 640})})
	const right = new Barrier({restitution: 0.8, shape: new BarrierShape({transform: new Transform(new Vector2({x: 370, y: 350}), 0), width: 30, height: 640})})
